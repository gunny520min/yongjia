  ...
  <body class="baoyang bg-muted">
    <form method="post" onsubmit="return false;">
      <section class="has-footer">
        <div class="list">
          ...
          <div class="item item-divider">当前公里数</div>
          <div class="item item-input">
            <input type="number" placeholder="请输入您爱车的行驶公里数" name="kilo" />
          </div>
    ...
    <script id="success" type="text/swig-template">
      <div class="masklayer flex">
        <div class="modal col">
          <div class="wrap">
            <h3 class="title text-center">预约成功（万公里）</h3>
