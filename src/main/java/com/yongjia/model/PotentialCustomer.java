...
public class PotentialCustomer {
    ...
    public static final String[] buytypeStrs = new String[]{"首次购车","增购","换购"};
    public static final String[] buyforStrs = new String[]{"家庭","公司","其他"};
    public static final String[] paytypeStrs = new String[]{"全款","贷款"};
