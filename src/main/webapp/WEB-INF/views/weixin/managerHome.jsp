      ...
      <div class="popup services padding">
          <c:choose>
            <c:when test="${wxuser.status == 2}">
              <a class="button button-block button-primary button-outline" href="/wx/view/appointWeixiu">预约维修</a>
              <a class="button button-block button-primary button-outline" href="/wx/view/appointBaoyang">预约保养</a>
              <a class="button button-block button-primary button-outline" href="/wx/view/appointKanche">预约看车</a>
              <a class="button button-block button-primary button-outline" href="/wx/view/appointNianshen">预约年审</a>
              <a class="button button-block button-primary button-outline" href="/wx/view/appointQita">其他</a>
            </c:when>
            <c:otherwise>
              <a class="button button-block button-primary button-outline owner-required">预约维修</a>
              <a class="button button-block button-primary button-outline owner-required">预约保养</a>
              <a class="button button-block button-primary button-outline" href="/wx/view/appointKanche">预约看车</a>
              <a class="button button-block button-primary button-outline owner-required">预约年审</a>
              <a class="button button-block button-primary button-outline owner-required">其他</a>
            </c:otherwise>
          </c:choose>
      </div>
    </div>
